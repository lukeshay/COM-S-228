...
import edu.iastate.summer18.cs228.ex3.ResizableArrayBag;
 ...
 */
@Total(value=38)
public class ResizableArrayBagTestScript {
	private ResizableArrayBag<String> rbag1, rbag2, rbag3;
	/**
	...
	@Before
	public void setUp() {
		rbag1 = new ResizableArrayBag<String>();
		rbag2 = new ResizableArrayBag<String>();
		rbag3 = new ResizableArrayBag<String>();
	}
